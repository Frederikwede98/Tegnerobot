...
public class Semester_projekt {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            File black_and_white_output = new File("C:\\Users\\frede\\Videos\\SDU Robot Diplom\\Semester projekt 1\\billeder\\black_and_white.jpg");
        ...
        File scale_input = new File("C:\\Users\\frede\\Videos\\SDU Robot Diplom\\Semester projekt 1\\billeder\\black_and_white.jpg");
        BufferedImage image = ImageIO.read(scale_input);
        BufferedImage resized = resize(image, 12, 24);
        File scale_output = new File("C:\\Users\\frede\\Videos\\SDU Robot Diplom\\Semester projekt 1\\billeder\\scale_output.jpg");
    ...
    public static int[][] compute(File file) {
        try {
            ...
            String[] position = {"X", "Y"};
            try (
                    PrintStream output = new PrintStream(new File("C:\\Users\\frede\\Videos\\SDU Robot Diplom\\Semester projekt 1\\billeder\\output_text.txt"));) {
                 for (int y = 0; y < h; y++) {
                for (int x = 0; x < w; x++) {
